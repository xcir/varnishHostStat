...
if __name__ == '__main__':
	try:
		opts,args = getopt.getopt(sys.argv[1:],"ajrVR:F:i:w:DP:n:",["start=", "sopath="])
	except getopt.GetoptError:
		print 'invalid option'
		print 'usage: varnishhoststat -r -j -i [interval] -a -F [filter pattern] -R [replace pattern] --start [second] --sopath [libvarnishapi.so] -w [file-name] -D -n [instance-name] -P [pid-file] -V'
		sys.exit(2)
